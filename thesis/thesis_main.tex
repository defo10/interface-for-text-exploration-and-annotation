...
%
\hypersetup{
	pdftitle={Interactive Visualization Interface for Text Exploration and Annotation},  % please, add the title of your thesis
    pdfauthor={Daniel Stachnik},   % please, add your name
